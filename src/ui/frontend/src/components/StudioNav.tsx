...
const items: Item[] = [
  ...
  },
  {
    to: "/runs",
    label: "Runs",
    icon: "M5 4h14a1 1 0 0 1 1 1v4H4V5a1 1 0 0 1 1-1zM4 11h16v8a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1zM8 14h4",
  },
  {
    to: "/hitl",
    label: "HITL",
...
export function StudioNav() {
  return (
    <aside className="z-10 hidden w-24 shrink-0 flex-col items-center gap-4 border-r border-slate-200 bg-white/80 py-5 backdrop-blur lg:flex">
